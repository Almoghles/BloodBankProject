...
namespace BloodBankSystem
{
    ...
    public partial class AddDonorControl1 : UserControl
    {
        private bool isEdit = false;
        private string donorId = "";
        public AddDonorControl1()
        {
            InitializeComponent();
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (!hasError)
            {
                //if (isEdit)
                //{
                //    bool success1 = DonorModel.updateDonor(donorId, textBox1.Text, textBox2.Text, comboBox1.SelectedItem.ToString(), textBox3.Text, dateTimePicker1.Value, textBox4.Text);
                //    if (success1)
                //    {
                ...
                //    else
                //    {
                //        MessageBox.Show(" An error occurred while adding", "Invalid update", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //    }
                bool success = DonorModel.AddDonor(textBox1.Text, textBox2.Text, comboBox1.SelectedItem.ToString(), textBox3.Text, dateTimePicker1.Value, textBox4.Text);
                if (success)
                {
        ...
        public void setData(string id, string name,string age, string bloodtype, string quantity, DateTime date, string phone)
        {
            textBox1.Text = name;
            textBox2.Text = age;
            comboBox1.SelectedItem = bloodtype;
